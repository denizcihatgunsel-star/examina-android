...
const styles = StyleSheet.create({
  ...
  catCard: { width: 140, height: 120, borderRadius: 18, padding: 14, justifyContent: 'space-between', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.08, shadowRadius: 4, elevation: 2 },
  catTitle: { fontSize: 15, fontWeight: '700', color: colors.ink },
  cover: { width: 160, height: 210, borderRadius: 18, padding: 14, justifyContent: 'flex-end', shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.12, shadowRadius: 8, elevation: 4 },
